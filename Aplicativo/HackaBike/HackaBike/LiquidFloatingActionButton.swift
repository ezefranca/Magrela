...
@objc public protocol LiquidFloatingActionButtonDelegate {
    ...
    optional func didSelectLiquidFloatingActionButton(isOpening: Bool)
}
...
public class LiquidFloatingActionButton : UIView {
    ...
    public func open() {
        ...
        self.delegate?.didSelectLiquidFloatingActionButton?(true)
    ...
    public func close() {
        ...
        self.delegate?.didSelectLiquidFloatingActionButton?(false)
    ...
    private func drawCircle() {
        ...
        if touching && responsible {
            self.circleLayer.backgroundColor = UIColor(red: 111/255, green: 82/255, blue: 105/255, alpha: 0.8).CGColor
        } else {
...
class CircleLiquidBaseView : ActionBarBaseView {
    ...
    var color: UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1.0) {
        didSet {
            engine?.color = color
...
public class LiquidFloatingCell : LiquittableCircle {
    ...
    let internalRatio: CGFloat = 0.85
    ...
    private func resizeSubviews() {
        let size = CGSize(width: frame.width * 0.7, height: frame.height * 0.7)
