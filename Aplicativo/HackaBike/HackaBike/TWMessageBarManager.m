...
CGFloat const kTWMessageBarStyleSheetMessageBarAlpha = 0.9f;
...
CGFloat const kTWMessageBarManagerDisplayDelay = 4.0f;
...
+ (void)initialize
{
	...
	{
        // Fonts
        kTWMessageViewTitleFont = [UIFont fontWithName:@"FiraSans-Regular" size:16.0];
        kTWMessageViewDescriptionFont = [UIFont fontWithName:@"FiraSans-Light" size:14.0];
...
+ (void)initialize
{
	...
	{
        // Colors (background)
        kTWDefaultMessageBarStyleSheetErrorBackgroundColor = [UIColor colorWithRed:255/255.0 green:100/255.0 blue:100/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha];
        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor colorWithRed:0/255.0 green:150/255.0 blue:0/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha];
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed:100/255.0 green:100/255.0 blue:255/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha];
        
        // Colors (stroke)
        kTWDefaultMessageBarStyleSheetErrorStrokeColor = [UIColor colorWithRed:255/255.0 green:100/255.0 blue:100/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha];
        kTWDefaultMessageBarStyleSheetSuccessStrokeColor = [UIColor colorWithRed:0/255.0 green:150/255.0 blue:0/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha];
        kTWDefaultMessageBarStyleSheetInfoStrokeColor = [UIColor colorWithRed:100/255.0 green:100/255.0 blue:255/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha];
    }
}
